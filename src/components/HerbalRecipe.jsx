...
const RECIPES = [
  // HAIR
  {
    ...
    time: "30 min",
    benefit: "Promotes growth",
    steps: [
      "Heat 200ml coconut oil in a pan on low flame.",
      "Add 2 tbsp dried amla powder and 2 tbsp bhringraj powder.",
      "Stir in 1 tbsp fenugreek seeds.",
      "Simmer on low heat for 20 min until aromatic.",
      "Strain through muslin cloth into a glass bottle.",
  ...
  },
  {
    ...
    time: "15 min",
    benefit: "Deep conditioning",
    steps: [
      "Soak 4 tbsp fenugreek seeds overnight in water.",
      "Grind into a smooth paste the next morning.",
      "Mix with 3 tbsp plain yoghurt.",
      "Add crushed hibiscus petals for extra shine.",
      "Apply from root to tip, cover with shower cap.",
      "Leave for 45 min then rinse thoroughly.",
    ],
  },
  // FACE
  {
  ...
  },
  {
    ...
    time: "5 min",
    benefit: "Pore tightening",
    steps: [
      "Blend ½ cup fresh rose petals with ¼ cup water.",
      "Strain through fine mesh cloth.",
      "Mix with 2 tbsp aloe vera gel.",
      "Add 1 tbsp witch hazel.",
      "Store in a spray bottle in the refrigerator.",
      "Spritz on face after cleansing morning and night.",
    ],
  },
  // BODY
  {
  ...
  },
  {
    ...
    steps: [
      ...
      "Melt 3 tbsp coconut oil and add to mixture.",
  ...
  // IMMUNITY
  {
    ...
    steps: [
      ...
      "Whisk in 1 tsp turmeric, ½ tsp ginger powder.",
      "Add ¼ tsp cinnamon and a pinch of black pepper.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Cool slightly, strain and mash berries.",
      "Mix in 1 cup raw honey. Refrigerate for up to 3 months.",
    ],
  },
  // DIGESTION
  {
  ...
  // SLEEP
  {
    ...
    time: "8 min",
    benefit: "Deep sleep aid",
    steps: [
      "Warm 1 cup of milk without boiling.",
      "Whisk in ½ tsp ashwagandha root powder.",
      "Add a pinch each of nutmeg and cardamom.",
      "Sweeten with raw honey after removing from heat.",
      "Sip slowly 30 minutes before bedtime.",
      "Practice consistently for 4–6 weeks.",
    ],
  },
  {
    id: 14,
    ...
    time: "12 min",
    benefit: "Reduces insomnia",
    video: "https://www.w3schools.com/html/mov_bbb.mp4",
    steps: [
      "Boil 1.5 cups of water and reduce to a simmer.",
      "Add 1 tsp dried valerian root, steep 10 min.",
      "Add 2 tbsp chamomile and passionflower flowers.",
      "Steep an additional 5 minutes.",
      "Strain and add a slice of lemon.",
  ...
  },
  {
    ...
    video: "https://www.w3schools.com/html/mov_bbb.mp4",
    steps: [
      "Soak 1 tsp each cumin, coriander and fennel seeds overnight.",
      "Boil the soaked seeds in the water in the morning.",
      "Simmer for 5 minutes then strain.",
      "Let it cool slightly — drink warm.",
      "Have on an empty stomach each morning.",
      "Maintain for 30 days for visible results.",
    ],
  },
];
...
const CategoryButton = ({ cat, active, count, onClick }) => (
  ...
  >
    ...
    <span
      className={`text-[11px] font-medium whitespace-nowrap ${active ? "text-[#e8e4d4]" : "text-[#4a5535]"}`}
    >
      {cat.label}
    </span>
    ...
    >
      ...
      <div className="relative w-full h-44 bg-[#eef0e6] overflow-hidden">
        ...
        <span className="absolute top-2.5 left-2.5 inline-flex items-center gap-1 bg-white/90 rounded-full px-2.5 py-1 text-[11px] font-medium text-[#2c3320]">
          {recipe.type === "video" ? (
            <>
              <Play size={10} fill="#2c3320" /> Video
            </>
          ) : (
            <>
      ...
      >
        ...
        <div className="relative">
          {recipe.type === "video" && recipe.video ? (
            <div
              className="relative w-full bg-black rounded-t-3xl overflow-hidden"
        ...
        <div className="p-6">
          ...
          <p className="text-[13px] text-[#5a6644] leading-relaxed mb-4">
            {recipe.desc}
          </p>
          ...
          <div className="flex flex-col gap-3 mb-5">
            {(Array.isArray(recipe.steps) ? recipe.steps : []).map((step, i) => (
              <div key={i} className="flex items-start gap-3">
                ...
                <p className="text-[13px] text-[#2c3320] leading-relaxed">
                  {step}
                </p>
              </div>
            ))}
    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-10  min-h-screen">
        ...
        <div className="flex flex-wrap gap-2.5 items-center mb-6">
          {/* Search */}
          <div
            className="flex-1 min-w-50 flex items-center gap-2 bg-white border-[1.5px] border-[#e4dfc8]
          ...
          >
            ...
            {search && (
              <button
                onClick={() => setSearch("")}
                className="text-[#9aaa7a] hover:text-[#4a5535]"
              >
                <X size={13} />
              </button>
            )}
        ...
        <p className="text-[12px] text-[#9aaa7a] mb-4">
          ...
          {activeCat !== "all" &&
            ` in ${CATEGORIES.find((c) => c.id === activeCat)?.label}`}
        </p>
        ...
        {filtered.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-[#9aaa7a]">
            ...
            <p className="text-[14px]">
              No herbal recipes found for your search.
            </p>
